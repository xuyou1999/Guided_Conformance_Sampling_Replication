...
#
# def plot_change_in_correlation(df, input_name):
#     print("> Correlation convergence")
#     subset_df = df.loc[df['sample_size'] == 200]
#     value_list_feature = []
#     value_list_sequence = []
#     for i in range(200):
#         column = "cor_change_" + str(i)
#         list_i_feature = subset_df.loc[subset_df['approach'] == 'Feature'][column]
#         value_list_feature.extend(list_i_feature)
#
#         list_i_feature = subset_df.loc[subset_df['approach'] == 'Sequence'][column]
#         value_list_sequence.extend(list_i_feature)
#
#     # print(value_list_feature)
#     # print(value_list_sequence)
#
#     # TODO how to handle -1 values???
#     mean_first_positive_correlation_feature = statistics.mean(
#         subset_df.loc[subset_df['approach'] == 'Feature']['first_positive_at'])
#     mean_first_positive_correlation_sequence = statistics.mean(
#         subset_df.loc[subset_df['approach'] == 'Sequence']['first_positive_at'])
#
#     x_list = range(0, 200)
#     x_list = list(itertools.chain.from_iterable(itertools.repeat(x, 10) for x in x_list))
#     plt.subplot(1, 2, 1)
#     sns.lineplot(x_list, value_list_feature)
#     plt.axvline(x=mean_first_positive_correlation_feature, c='darkgrey', ls='--')
#     plt.title("Feature")
#
#     plt.subplot(1, 2, 2)
#     sns.lineplot(x_list, value_list_sequence)
#     plt.axvline(x=mean_first_positive_correlation_sequence, c='darkgrey', ls='--')
#     plt.title("Sequence")
#
#     plt.savefig(os.path.join("figures", "convergence_correlation_" + input_name + ".pdf"), format="pdf")
#     plt.clf()
#
#
